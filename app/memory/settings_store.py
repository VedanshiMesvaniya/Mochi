...
*user preferences* that aren't worth their own table, e.g. which glow
theme is active - not for app configuration (that stays in .env, see
app/core/config.py).
"""
